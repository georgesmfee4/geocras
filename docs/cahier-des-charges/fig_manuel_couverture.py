# -*- coding: utf-8 -*-
"""Page de garde du manuel technique, à fond perdu, dans la charte GeoCras.
...
# ------------------------------------------------------------ bas du champ
s.text(190, 700, "DOCUMENT INTERNE", size=30, fill="#FFFFFF",
       font=BEBAS, ls="6.5", weight="400")
s.add(f'<rect x="190" y="742" width="86" height="5" fill="#FFFFFF"/>')
s.text(190, 826, "Manuel technique", size=52, fill="#FFFFFF", font=BEBAS, ls="2.4")
s.text(190, 890, "les rouages du projet, pas à pas", size=52, fill="#FFFFFF", font=BEBAS, ls="2.4")
...
s.text(196, WY + 74, "Installer, comprendre et modifier le projet",
...
MY = WY + 342
COLS = [
    ("OBJET", ["Maîtrise du code"]),
    ("DESTINATAIRE", ["MFEE Georges"]),
]
...
s.text(830, MY + 76, "usage personnel", size=30, fill="#6E6A62", font=PLEX)
...
s.save("figures/00-manuel-couverture.svg")
print("ok")
